...
class _$StripeTerminal extends StripeTerminal {
  _$StripeTerminal() : super._() {
    _channel.setMethodCallHandler((call) async {
      ...
      return switch (call.method) {
        'RequestConnectionToken' => await _onRequestConnectionToken(),
        'ReadersFound' => await _onReadersFound((args[0] as List)
  ...
  @override
  Future<void> listLocations() async {
    await _channel.invokeMethod('listLocations', []);
  }
