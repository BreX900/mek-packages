...
class SimulatorConfigurationApi {
  ...
  final SimulateReaderUpdateApi update;
  ...
  final SimulatedCardApi simulatedCard;
  ...
  const SimulatorConfigurationApi({
    this.update = SimulateReaderUpdateApi.available,
    this.simulatedCard = const SimulatedCardApi(type: SimulatedCardTypeApi.visa),
...
class SimulatedCardApi {
  final SimulatedCardTypeApi? type;
  final String? testCardNumber;

  const SimulatedCardApi({this.type, this.testCardNumber});

  // /// Create a Simulated Card object with a given simulated card type.
  // const SimulatedCardApi.fromType(SimulatedCardTypeApi this.type) : testCardNumber = null;
  //
  ...
  // /// creating a corresponding [SimulatedCardTypeApi]. The card number entered here must be in the list
  // /// of test card numbers.
  // ///
  // /// See: https://stripe.com/docs/terminal/testing#simulated-test-cards
  // const SimulatedCardApi.fromTestCardNumber(String this.testCardNumber) : type = null;
}
