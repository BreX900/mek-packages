...
enum TerminalExceptionCodeApi {
  ...
  /// See [message] field
  readerNotRecovered, // ('Call this method with the [Reader] returned from the [StripeTerminal.discoverReaders] method.')
  /// See [message] field
...
class TerminalExceptionApi {
  final TerminalExceptionCodeApi code;
  final String message;
  final String? stackTrace;
  final PaymentIntentApi? paymentIntent;
