...
GroupMediaOpenApi _$GroupMediaOpenApiFromJson(Map json) => $checkedCreate(
  ...
  ($checkedConvert) {
    final val = GroupMediaOpenApi(
      ...
      image: $checkedConvert('image/*', (v) => v == null ? null : MediaOpenApi.fromJson(v as Map)),
...
SchemaOpenApi _$SchemaOpenApiFromJson(Map json) => $checkedCreate('SchemaOpenApi', json, (
  $checkedConvert,
) {
  final val = SchemaOpenApi(
    ...
    enum$: $checkedConvert('enum', (v) => (v as List<dynamic>?)?.map((e) => e as Object).toList()),
    items: $checkedConvert('items', (v) => v == null ? null : SchemaOpenApi.fromJson(v as Map)),
    properties: $checkedConvert(
      'properties',
      (v) => (v as Map?)?.map((k, e) => MapEntry(k as String, SchemaOpenApi.fromJson(e as Map))),
    ),
