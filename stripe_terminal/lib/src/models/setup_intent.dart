...
class SetupAttemptPaymentMethodDetails with _$SetupAttemptPaymentMethodDetails {
  ...
  @internal
  const SetupAttemptPaymentMethodDetails({this.cardPresent, this.interacPresent});
}
...
class SetupAttemptCardPresentDetails with _$SetupAttemptCardPresentDetails {
  ...
  const SetupAttemptCardPresentDetails({required this.emvAuthData, required this.generatedCard});
}
