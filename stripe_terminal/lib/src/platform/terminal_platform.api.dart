...
class _$TerminalPlatform implements TerminalPlatform {
  static const _$channel = MethodChannel(
    'mek_stripe_terminal#TerminalPlatform',
  );
  ...
  Stream<List<Reader>> discoverReaders(DiscoveryConfiguration configuration) {
    return _$discoverReaders
        .receiveBroadcastStream([
          _$serializeDiscoveryConfiguration(configuration),
        ])
        .map(
          (e) =>
              (e as List).map((e) => _$deserializeReader(e as List)).toList(),
        )
        .handleError((error, _) {
          if (error is PlatformException)
            TerminalPlatform._throwIfIsHostException(error);
          throw error;
        });
  }
  ...
  Future<PaymentIntent> startCollectPaymentMethod({
    ...
    try {
      final result = await _$channel.invokeMethod('startCollectPaymentMethod', [
        ...
        surchargeNotice,
        skipTipping,
        tippingConfiguration != null
            ? _$serializeTippingConfiguration(tippingConfiguration)
            : null,
  ...
  Future<PaymentIntent> cancelPaymentIntent(String paymentIntentId) async {
    try {
      final result = await _$channel.invokeMethod('cancelPaymentIntent', [
        paymentIntentId,
      ]);
      return _$deserializePaymentIntent(result as List);
    } on PlatformException catch (exception) {
  ...
  Future<SetupIntent> retrieveSetupIntent(String clientSecret) async {
    try {
      final result = await _$channel.invokeMethod('retrieveSetupIntent', [
        clientSecret,
      ]);
      return _$deserializeSetupIntent(result as List);
    } on PlatformException catch (exception) {
  ...
  Future<void> stopCollectSetupIntentPaymentMethod(int operationId) async {
    try {
      await _$channel.invokeMethod('stopCollectSetupIntentPaymentMethod', [
        operationId,
      ]);
    } on PlatformException catch (exception) {
      TerminalPlatform._throwIfIsHostException(exception);
  ...
  Future<SetupIntent> startConfirmSetupIntent(
    ...
    try {
      final result = await _$channel.invokeMethod('startConfirmSetupIntent', [
        operationId,
        setupIntentId,
      ]);
      return _$deserializeSetupIntent(result as List);
  ...
  Future<SetupIntent> cancelSetupIntent(String setupIntentId) async {
    try {
      final result = await _$channel.invokeMethod('cancelSetupIntent', [
        setupIntentId,
      ]);
      return _$deserializeSetupIntent(result as List);
    } on PlatformException catch (exception) {
  ...
  Future<void> stopCollectRefundPaymentMethod(int operationId) async {
    try {
      await _$channel.invokeMethod('stopCollectRefundPaymentMethod', [
        operationId,
      ]);
    } on PlatformException catch (exception) {
      TerminalPlatform._throwIfIsHostException(exception);
  ...
  Future<Refund> startConfirmRefund(int operationId) async {
    try {
      final result = await _$channel.invokeMethod('startConfirmRefund', [
        operationId,
      ]);
...
void _$setupTerminalHandlers(TerminalHandlers hostApi) {
  ...
  channel.setMethodCallHandler((call) async {
    ...
    return switch (call.method) {
      ...
      '_onReaderReportEvent' => hostApi._onReaderReportEvent(
        ReaderEvent.values[args[0] as int],
      ),
      ...
      '_onDisconnect' => hostApi._onDisconnect(
        DisconnectReason.values[args[0] as int],
      ),

      '_onReaderRequestDisplayMessage' => hostApi
      ...
      '_onReaderReportAvailableUpdate' => hostApi
          ._onReaderReportAvailableUpdate(
            _$deserializeReaderSoftwareUpdate(args[0] as List),
          ),

      '_onReaderStartInstallingUpdate' => hostApi
          ._onReaderStartInstallingUpdate(
            _$deserializeReaderSoftwareUpdate(args[0] as List),
          ),

      '_onReaderReportSoftwareUpdateProgress' => hostApi
          ._onReaderReportSoftwareUpdateProgress(args[0] as double),

      '_onReaderFinishInstallingUpdate' => hostApi
      ...
      _ =>
        throw UnsupportedError(
          'TerminalHandlers#Flutter.${call.method} method',
        ),
    };
  });
}
...
AmountDetails _$deserializeAmountDetails(
...
CardDetails _$deserializeCardDetails(List<Object?> serialized) => CardDetails(
  ...
  funding:
      serialized[4] != null
          ? CardFundingType.values[serialized[4] as int]
          : null,
...
CardPresentDetails _$deserializeCardPresentDetails(List<Object?> serialized) =>
    CardPresentDetails(
      ...
      funding:
          serialized[6] != null
              ? CardFundingType.values[serialized[6] as int]
              : null,
      generatedCard: serialized[7] as String?,
      incrementalAuthorizationStatus:
          serialized[8] != null
              ? IncrementalAuthorizationStatus.values[serialized[8] as int]
              : null,
      last4: serialized[9] as String?,
      networks:
          serialized[10] != null
              ? _$deserializeCardNetworks(serialized[10] as List)
              : null,
      receipt:
          serialized[11] != null
              ? _$deserializeReceiptDetails(serialized[11] as List)
              : null,
    );
List<Object?> _$serializeCardPresentParameters(
  CardPresentParameters deserialized,
) => [
...
Charge _$deserializeCharge(List<Object?> serialized) => Charge(
  ...
  metadata: (serialized[6] as Map).map(
    (k, v) => MapEntry(k as String, v as String),
  ),
  paymentMethodDetails:
      serialized[7] != null
          ? _$deserializePaymentMethodDetails(serialized[7] as List)
          : null,
...
List<Object?> _$serializeConnectionConfiguration(
  ...
  HandoffConnectionConfiguration() => _$serializeHandoffConnectionConfiguration(
    deserialized,
  ),
  InternetConnectionConfiguration() =>
    _$serializeInternetConnectionConfiguration(deserialized),
  TapToPayConnectionConfiguration() =>
    _$serializeTapToPayConnectionConfiguration(deserialized),
  UsbConnectionConfiguration() => _$serializeUsbConnectionConfiguration(
    deserialized,
  ),
};
...
List<Object?> _$serializeUsbConnectionConfiguration(
  UsbConnectionConfiguration deserialized,
) => [
  'UsbConnectionConfiguration',
  deserialized.autoReconnectOnUnexpectedDisconnect,
  deserialized.locationId,
];
List<Object?> _$serializeDiscoveryConfiguration(
  DiscoveryConfiguration deserialized,
) => switch (deserialized) {
  BluetoothDiscoveryConfiguration() =>
    _$serializeBluetoothDiscoveryConfiguration(deserialized),
  BluetoothProximityDiscoveryConfiguration() =>
    _$serializeBluetoothProximityDiscoveryConfiguration(deserialized),
  HandoffDiscoveryConfiguration() => _$serializeHandoffDiscoveryConfiguration(
    deserialized,
  ),
  InternetDiscoveryConfiguration() => _$serializeInternetDiscoveryConfiguration(
    deserialized,
  ),
  TapToPayDiscoveryConfiguration() => _$serializeTapToPayDiscoveryConfiguration(
    deserialized,
  ),
  UsbDiscoveryConfiguration() => _$serializeUsbDiscoveryConfiguration(
    deserialized,
  ),
};
...
List<Object?> _$serializeUsbDiscoveryConfiguration(
  UsbDiscoveryConfiguration deserialized,
) => [
...
Location _$deserializeLocation(List<Object?> serialized) => Location(
  ...
  metadata: (serialized[4] as Map).map(
    (k, v) => MapEntry(k as String, v as String),
  ),
);
PaymentIntent _$deserializePaymentIntent(List<Object?> serialized) =>
    PaymentIntent(
      amount: serialized[0] as double,
      amountCapturable: serialized[1] as double?,
      amountDetails:
          serialized[2] != null
              ? _$deserializeAmountDetails(serialized[2] as List)
              : null,
      ...
      canceledAt:
          serialized[7] != null
              ? DateTime.fromMillisecondsSinceEpoch(serialized[7] as int)
              : null,
      cancellationReason: serialized[8] as String?,
      captureMethod: CaptureMethod.values[serialized[9] as int],
      charges:
          (serialized[10] as List)
              .map((e) => _$deserializeCharge(e as List))
              .toList(),
      clientSecret: serialized[11] as String?,
      confirmationMethod:
          serialized[12] != null
              ? ConfirmationMethod.values[serialized[12] as int]
              : null,
      ...
      metadata: (serialized[19] as Map).map(
        (k, v) => MapEntry(k as String, v as String),
      ),
      onBehalfOf: serialized[20] as String?,
      paymentMethod:
          serialized[21] != null
              ? _$deserializePaymentMethod(serialized[21] as List)
              : null,
      ...
      setupFutureUsage:
          serialized[25] != null
              ? PaymentIntentUsage.values[serialized[25] as int]
              : null,
...
List<Object?> _$serializePaymentIntentParameters(
  ...
  deserialized.paymentMethodOptionsParameters != null
      ? _$serializePaymentMethodOptionsParameters(
        deserialized.paymentMethodOptionsParameters!,
      )
      : null,
...
PaymentMethod _$deserializePaymentMethod(List<Object?> serialized) =>
    PaymentMethod(
      card:
          serialized[0] != null
              ? _$deserializeCardDetails(serialized[0] as List)
              : null,
      cardPresent:
          serialized[1] != null
      ...
      interacPresent:
          serialized[4] != null
              ? _$deserializeCardPresentDetails(serialized[4] as List)
              : null,
      metadata: (serialized[5] as Map).map(
        (k, v) => MapEntry(k as String, v as String),
      ),
    );
...
Reader _$deserializeReader(List<Object?> serialized) => Reader(
  ...
  location:
      serialized[4] != null
          ? _$deserializeLocation(serialized[4] as List)
          : null,
  locationId: serialized[5] as String?,
  locationStatus:
      serialized[6] != null
          ? LocationStatus.values[serialized[6] as int]
          : null,
  serialNumber: serialized[7] as String,
  simulated: serialized[8] as bool,
);
List<Object?> _$serializeReaderDelegateAbstract(
  ReaderDelegateAbstract deserialized,
) => switch (deserialized) {
...
List<Object?> _$serializeMobileReaderDelegate(
  MobileReaderDelegate deserialized,
) => ['MobileReaderDelegate'];
List<Object?> _$serializeHandoffReaderDelegate(
  HandoffReaderDelegate deserialized,
) => ['HandoffReaderDelegate'];
List<Object?> _$serializeInternetReaderDelegate(
  InternetReaderDelegate deserialized,
) => ['InternetReaderDelegate'];
List<Object?> _$serializeTapToPayReaderDelegate(
  TapToPayReaderDelegate deserialized,
...
Refund _$deserializeRefund(List<Object?> serialized) => Refund(
  ...
  status:
      serialized[9] != null ? RefundStatus.values[serialized[9] as int] : null,
);
...
SetupIntent _$deserializeSetupIntent(List<Object?> serialized) => SetupIntent(
  ...
  latestAttempt:
      serialized[3] != null
          ? _$deserializeSetupAttempt(serialized[3] as List)
          : null,
  metadata: (serialized[4] as Map).map(
    (k, v) => MapEntry(k as String, v as String),
  ),
...
List<Object?> _$serializeSimulatorConfiguration(
  SimulatorConfiguration deserialized,
) => [
...
TerminalException _$deserializeTerminalException(List<Object?> serialized) =>
    TerminalException(
      ...
      paymentIntent:
          serialized[3] != null
              ? _$deserializePaymentIntent(serialized[3] as List)
              : null,
      stackTrace: serialized[4] as String?,
    );
Tip _$deserializeTip(List<Object?> serialized) =>
    Tip(amount: serialized[0] as int?);
List<Object?> _$serializeTippingConfiguration(
  TippingConfiguration deserialized,
